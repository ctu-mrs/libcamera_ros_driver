...
def generate_launch_description():
    ...
    left = camera_node(LaunchConfiguration("left_name"), LaunchConfiguration("left_custom_config"), LaunchConfiguration("left_calib_url"))
    right = camera_node(LaunchConfiguration("right_name"), LaunchConfiguration("right_custom_config"), LaunchConfiguration("right_calib_url"))
