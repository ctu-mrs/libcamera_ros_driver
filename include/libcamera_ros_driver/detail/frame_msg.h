...
namespace libcamera_ros_driver::detail
{
  ...
  inline sensor_msgs::Image fillImageMsg(const std_msgs::Header& hdr, uint32_t width, uint32_t height, uint32_t step, const std::string& encoding,
                                         const uint8_t* src, size_t size, int fd)
  {
  ...
  inline sensor_msgs::Image fillImageMsgMono8(const std_msgs::Header& hdr, uint32_t width, uint32_t height, uint32_t src_stride, const uint8_t* src, int fd,
                                              int shift)
  {
    sensor_msgs::Image msg;
    msg.header = hdr;
